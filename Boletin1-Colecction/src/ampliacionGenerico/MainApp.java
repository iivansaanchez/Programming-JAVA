...
public class MainApp {
	...
	public static void main(String[] args) throws AlumnoException {
		...
		//Creacion de Equipos
		Equipo<Alumno> betis = new Equipo<>("Real Betis Balompie");
		Equipo<Integer> sevilla = new Equipo<>("Sevilla FC");
		//Añadimos alumnos a Equipo betis;
		betis.anadirAlumno(ivan);
		sevilla.anadirAlumno(3);
		...
		sevilla.anadirAlumno(4);
		sevilla.anadirAlumno(5);
		...
		System.out.println(betis.unionEquipo(betis));
		...
		System.out.println(sevilla.unionJugadoresComun(sevilla));
